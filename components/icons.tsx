...
export const KNRRLogoIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
         <style>
            {`.knrr-text { font-family: 'Arial', sans-serif; font-weight: bold; }`}
        </style>
        <circle cx="100" cy="100" r="98" fill="white"/>
        <circle cx="100" cy="100" r="95" fill="white" stroke="#d12727" strokeWidth="10"/>
...
export const BRILLogoIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        <circle cx="100" cy="100" r="95" fill="transparent" stroke="#d12727" strokeWidth="10"/>
        <circle cx="100" cy="100" r="75" fill="none" stroke="#0033a0" strokeWidth="2"/>
...
export const BRIGLogoIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        <circle cx="100" cy="100" r="95" fill="transparent" stroke="#d12727" strokeWidth="10"/>
        <circle cx="100" cy="100" r="75" fill="none" stroke="#0033a0" strokeWidth="2"/>
        <path d="M100 40 L130 90 L100 80 L70 90 Z" fill="#0033a0"/>
...
>
  ...
  {/* Curved Text - ACCREDITED WITH GRADE (Moved Lower for Rainbow Arc) */}
  <path
    id="topTextPath"
    d="M120,200 A150,150 0 0,1 392,200"
    fill="none"
  />
  <text
    fontFamily="Arial, sans-serif"
