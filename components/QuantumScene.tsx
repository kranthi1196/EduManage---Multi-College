...
// Removed the declare global block that was shadowing JSX.IntrinsicElements and breaking standard HTML element types globally.
// As the file is marked with @ts-nocheck, internal Three.js element errors will be ignored while restoring global React JSX types.
