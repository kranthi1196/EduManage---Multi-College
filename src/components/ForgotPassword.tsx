        ...
        {step === 2 && (
          <form onSubmit={handleOtpsSubmit} className="space-y-4">
            ...
            <p className="text-sm text-slate-500">
              OTPs have been sent to your registered mobile and email. For this demo, use{' '}
              <span className="font-bold text-slate-700">{DEMO_MOBILE_OTP}</span> for mobile and{' '}
              <span className="font-bold text-slate-700">{DEMO_EMAIL_OTP}</span> for email.
            </p>
            <div>
