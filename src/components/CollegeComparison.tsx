        ...
        const fetchComparisonData = async () => {
            ...
            try {
                if (selectedCollege === College.ALL) {
                    const params = [selectedYear, 'all', 'all', 'all', 'all', selectedDate, selectedDate, 'all', 'All Subjects'] as const;
                    ...
                    const deptDataPromises = DEPARTMENTS.map((dept: string) => getDashboardData(selectedCollege, selectedYear, dept, 'all', 'all', 'all', selectedDate, selectedDate, 'all', 'All Subjects'));
