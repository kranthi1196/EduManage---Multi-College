...
// FIX: Added 'getStudentDetails' to the import list.
...
// FIX: Corrected import path to explicitly include '/index'.
...
// FIX: Update DashboardProps to accept all shared filter states and download handlers from the parent component.
...
const Dashboard: React.FC<DashboardProps> = ({ 
    ...
    useEffect(() => {
      ...
      }, [debouncedFacultyId, setSelectedDepartment, setSelectedYear, setSelectedRollNo, setSelectedStaffId, setSelectedSemester]);
      ...
      }, [debouncedStaffId, setSelectedDepartment, setSelectedYear, setSelectedRollNo, setSelectedFacultyId, setSelectedSemester]);
