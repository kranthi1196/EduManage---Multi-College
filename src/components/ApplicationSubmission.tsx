        ...
        <form onSubmit={handleSubmit} className="space-y-8"> 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-6"> 
                ...
                <div className="space-y-6"> 
                    ...
                    <Field label="Admission Type"><select name="admissionType" value={formData.admissionType} onChange={handleChange} className={commonSelectClass}><option>Counselling Seat/Scholarship/Sports Quota</option><option>Management / Payment Seat</option><option>Donation / NRI Seat</option></select></Field> 
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            if (result.success) {
                ...
                // AUTOMATICALLY ADD NOTIFICATION FOR SYLLABUS UPLOAD
                const newSyllabusNotif = {
                    id: Date.now(),
                    title: `Syllabus 2020: ${department} Updated`, 
                ...
                localStorage.setItem('exam_notifications', JSON.stringify([newSyllabusNotif, ...existingNotifs]));
