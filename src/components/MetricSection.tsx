        ...
        switch(type) {
            ...
            case 'staff':
             ...
             case 'studentFee':
                const sf = metrics as DashboardData['studentFees'];
                return <>
                    <DashboardCard title="Total Fees (₹)" value={sf.totalFees.toLocaleString('en-IN')} icon={<CurrencyDollarIcon />} color="blue" />
                    <DashboardCard title="Collected (₹)" value={sf.paidAmount.toLocaleString('en-IN')} icon={<CheckCircleIcon />} color="green" />
                    <DashboardCard title="Due (₹)" value={sf.dueAmount.toLocaleString('en-IN')} icon={<XCircleIcon />} color="red" />
