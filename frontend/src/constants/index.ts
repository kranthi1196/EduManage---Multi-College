...
export const MOCK_USERS: User[] = [
    ...
    // HOD
    { id: 'dharmaraj', name: 'Dr. Dharmaraj', email: 'dharmaraj.hod@edu.com', password: 'password123', role: Role.HOD, college: College.BRIL, department: 'CSE' },

    // Faculty
    { id: 'BCSE01032020-001', name: 'Prof. B. Verma', email: 'faculty.biet@edu.com', password: 'password123', role: Role.FACULTY, college: College.BRIL, department: 'CSE' },
    { id: 'GECE15022020-001', name: 'Prof. G. Reddy', email: 'faculty.bgiit@edu.com', password: 'password123', role: Role.FACULTY, college: College.BRIG, department: 'ECE' },
...
export const DEPT_REMARKS: Record<string, string> = {
  'CSE': 'Most popular specialization',
  'ECE': '-',
  'EEE': '-',
  'MECH': '-',
  'CIVIL': '-',
  'HS': 'Foundation courses',
  'CSM': 'AI & ML focused program',
  'CSD': 'Specialized CSE stream',
  'CSC': 'Specialized CSE stream',
};
